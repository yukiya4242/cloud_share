				...
				<div class="py-10">
					<div x-show.transition.in="step === 1">
						...
						<label
							...
							<input id="profile_image" type="file" name="profile_image" accept="image/*" class="hidden" type="file" @change="let file = document.getElementById('profile_image').files[0];
						...
						<div class="mb-5">
							<label for="firstname" class="font-bold mb-1 text-gray-700 block" for="name">Name</label>
							<input type="text"
								class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium"
								placeholder="Enter your firstname..." id="name" type="text" name="name" value="{{ Auth::user()->name }}">
						</div>
						...
						<div class="mb-5">
							...
							<input type="email"
								class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium"
								placeholder="Enter your email address..." id="email" type="text" name="email" value="{{ Auth::user()->email }}">
						</div>
