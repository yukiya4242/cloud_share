...
<div class="h-screen">
	...
	<div x-data="app()" x-cloak>
		<div class="max-w-3xl mx-auto px-4 py-10">
		    <form method="POST" action="{{ route('photo.store') }}" class="bg-white shadow-md rounded px-8 p-6 pb-8 mb-4 mt-3" enctype="multipart/form-data">
                @csrf
				...
				<div class="py-10">
                  ...
                  @enderror
						...
						<div class="mb-5">
							<label for="title" class="font-bold mb-1 text-gray-700 block" for="name">Title</label>
							<input type="text"
								...
								placeholder="Write title..." id="title" type="text" name="title">
						...
						<div class="mb-5">
							...
							<input type="caption"
								...
								placeholder="Write photo's caption..." id="caption" type="text" name="caption" required>
						</div>
						...
						<div class="mb-5">
							...
							<input type=""
								...
								placeholder="35.658584" id="caption" type="text" name="latitude" required>
                ...
                @enderror
						...
						<div class="mb-5">
							...
							<input type="longitude"
								...
								placeholder="139.7454316" id="longitude" type="text" name="longitude">
